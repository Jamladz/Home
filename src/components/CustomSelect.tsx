      ...
      <AnimatePresence>
        {isOpen && !disabled && (
          <motion.div
            ...
            className={`absolute z-[999] w-full mt-1.5 bg-white rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] border border-slate-100 max-h-60 overflow-y-auto ${dropdownClassName}`}

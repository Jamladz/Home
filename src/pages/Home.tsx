...
export default function Home() {
  ...
  return (
    <div className="pb-8">
      {/* Header / Hero */}
      <div className="bg-gradient-to-l from-indigo-600 to-indigo-800 rounded-b-[40px] p-6 pt-12 pb-16 text-white shadow-sm relative overflow-hidden">
      ...
      <div className="mt-[-2rem] px-4 relative z-10">
        <div className="flex gap-4 overflow-x-auto pb-4 hide-scrollbar">
          {categories.map((cat, idx) => (
            <div key={idx} className="flex-shrink-0 bg-white rounded-3xl p-4 shadow-sm border border-slate-200/60 w-28 flex flex-col items-center justify-center gap-3 hover:border-indigo-200 transition-colors">
